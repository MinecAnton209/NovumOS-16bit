...
| Registers | [en/architecture/registers.md](en/architecture/registers.md) |
| Execution Cycle | [en/architecture/execution-cycle.md](en/architecture/execution-cycle.md) |
| Memory Map | [en/architecture/memory-map.md](en/architecture/memory-map.md) |

### Instruction Set Architecture
| Topic | Link |
|-------|------|
| Instruction Set | [en/isa/instruction-set.md](en/isa/instruction-set.md) |
| Instruction Encoding | [en/isa/instruction-encoding.md](en/isa/instruction-encoding.md) |
| Flags Behavior | [en/isa/flags-behavior.md](en/isa/flags-behavior.md) |

### Peripherals
| Topic | Link |
|-------|------|
| Overview | [en/peripherals/overview.md](en/peripherals/overview.md) |
| PIC 8259 | [en/peripherals/pic.md](en/peripherals/pic.md) |
| PIT 8254 | [en/peripherals/pit.md](en/peripherals/pit.md) |
| UART 16550 | [en/peripherals/uart.md](en/peripherals/uart.md) |
| VGA Text Mode | [en/peripherals/vga.md](en/peripherals/vga.md) |

### Boot & Build
| Topic | Link |
|-------|------|
| Boot Process | [en/boot/boot-process.md](en/boot/boot-process.md) |
| Toolchain | [en/build/toolchain.md](en/build/toolchain.md) |
