...
block-beta
    ...
    block:attr:8
        columns 8
        BL["BL<br/>bit 15"] BI["I<br/>bit 14"] BG2["BG<br/>bit 13"] BG1["BG<br/>bit 12"]
        BG0["BG<br/>bit 11"] FL["FLASH<br/>bit 10"] FG2["FG<br/>bit 9"] FG1["FG<br/>bit 8"]
    end
    block:sym:8
        columns 8
...
|-----|----------|----------|
| 15 | BL (Blink) | Мигание. 1 = символ мигает. 0 = без мигания. |
| 14 | I (Intensity) | Яркость. 1 = увеличенная яркость. 0 = нормальная. |
| 13:11 | BG (Background) | 3-битный цвет фона (RGB: 0-7) |
| 10 | FLASH | Режим мигания |
| 9:7 | FG (Foreground) | 3-битный цвет переднего плана (RGB: 0-7) |
| 7:0 | Symbol | Код символа |
